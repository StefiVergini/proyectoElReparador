...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-06-2025 a las 18:02:08
...
--
-- Volcado de datos para la tabla `atencion_presupuesto`
--
...
(46, 1, 12, '170000.00', '2025-05-22', '2025-06-07', '2025-06-07', 1, 'Presupuesto Confirmado', 'Materiales: mother cooler Detalle de la Reparación: se cambiara el mother y cooler, ya que producen los apagados repentinos'),
(47, 1, 12, '50000.00', '2025-05-22', '2025-06-07', '2025-06-07', 1, 'Reparacion Finalizada', 'Materiales: motor Detalle de la Reparación: se cambiara el motor'),
...
(17, 'Reparación ID 46', '2025-06-07', '15:20:00', '15:20:00', '2025-06-16', 12, 1),
...
(5, 1, 'La Reparación #46 del cliente: Pablo Pereyra ha sido Confirmada', '/php/proyectoElReparador/electrodomesticos/inicioElectro.php', 0, '2025-06-07 18:19:20'),
...
(8, 1, 'La Reparación #47 del cliente: Pablo Pereyra ha sido Confirmada', '/php/proyectoElReparador/electrodomesticos/inicioElectro.php', 0, '2025-06-07 20:13:58'),
...
(46, 46, 12, '2025-06-07', '2025-06-16', NULL, NULL, NULL, NULL, 1),
(47, 47, 12, '2025-06-07', '2025-06-11', '2025-06-07', NULL, NULL, NULL, 0),
...
(9, 'Display Samsung A54', 4, 'Electronica', 5, 1),
...
(17, 'Pasta Termica', 20, 'Herramientas', 1, 1),
...
--
ALTER TABLE `calendario`
  MODIFY `idcalendario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
