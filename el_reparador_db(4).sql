...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 04, 2025 at 05:48 PM
...
CREATE TABLE `atencion_presupuesto` (
  ...
  `nro_comprobante_pago_ini` varchar(25) DEFAULT NULL,
  `monto_pago_inicial` decimal(10,0) DEFAULT NULL,
...
INSERT INTO `atencion_presupuesto` (`id_reparacion`, `nro_comprobante_pago_ini`, `monto_pago_inicial`, `idemp_atencion`, `idemp_presup`, `presupuesto`, `fecha_env_presup`, `fecha_confirma_re`, `confirm_presup`, `observaciones`) VALUES
(32, NULL, NULL, 1, NULL, 80000.00, '2025-03-17', NULL, NULL, 'Materiales: Ficha USB tipo C Detalle de la Reparación: Cambiaremos la Ficha de carga del Celular debido que afecta la carga del mismo.');
...
(4, 12, 'jlennon@gmail.com', '$2y$08$xuGCWKOLJvMmqbkcSJlll.QE50Eq7oqtRNGVLbbV6YmFKOZLlsB2G');
...
(32, 'motorola', 'edge 30 ', '77755566666', 'no carga el celular', 7, 2);
...
(32, 32, 12, '2025-03-17', NULL, NULL, NULL, NULL, NULL, 1);
...
--
ALTER TABLE `electrodomesticos`
  MODIFY `idelectrodomesticos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `historial_empleados`
  MODIFY `idhistorial_empleados` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `reparaciones`
  MODIFY `id_reparacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
