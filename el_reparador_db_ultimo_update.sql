...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2025 at 01:16 AM
...
(35, 1, NULL, NULL, '2025-05-06', NULL, NULL, 0, 'Presupuesto a Enviar', NULL);
...
--
ALTER TABLE `electrodomesticos`
  MODIFY `idelectrodomesticos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `reparaciones`
  MODIFY `id_reparacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
