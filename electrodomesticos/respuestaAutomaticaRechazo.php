...
function rtaAutomaticaRechazo($mailCli,$nomCli,$idRepa){
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = 'Reparacion Rechazada';
        $mail->Body = "
                    <html>
                        <body style='background-color: #8497c5; font-family: Segoe UI, Tahoma, Geneva, Verdana, sans-serif; margin: 0; padding: 10px; border-radius: 10px;'>
                            ...
                            <p style='text-align: center; font-weight: bold; font-size: 18px;'>Hemos recibido su respuesta sobre el Presupuesto: ha sido Rechazado</p>
                            <p style='text-align: center; font-weight: bold; font-size: 18px; margin: 15px 0;'>Informamos que puede retirar su electrodoméstico</p>
                            <br>
                            <hr>
                            <p style='text-align: center; font-weight: bold; font-size: 18px;'>Ante cualquier otra reparación no dude en contactarnos.</p>
