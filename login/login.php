...
try {
    ...
    $sql = "SELECT e.email_empleado, c.password, c.usuario, e.idempleados, e.nom_empleado, e.idlocal, h.idcategorias_empleados 
            FROM empleados AS e 
    ...
    while ($registro = $resultado->fetch(PDO::FETCH_ASSOC)) {
        if (password_verify($contrasenia, $registro["password"])) {
            ...
            $_SESSION['nombre'] = $registro['nom_empleado'];
            $_SESSION['local'] = $registro['idlocal'];
            ...
            if($contrasenia == '1234'){
                ...
                header('location: /php/proyectoElReparador/electrodomesticos/inicioElectro.php');
                exit();
            }
        }
    }
